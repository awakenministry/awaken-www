jQuery(document).ready(function ($) {
    ...
    if ($('.defaultCountdown').length) {
        ...
        var aprilDay = new Date();
        aprilDay = new Date(2017,3,21,19,30,00);
        $('.marchCountdown').countdown({until: new Date(2017,2,24,19,30,00), format: 'dHMS'});
        $('.marchCountdownasdf').countdown({until: new Date(2017,2,24,19,30), format: 'dHM'});
        $('.aprilCountdown').countdown({until: aprilDay});
        $('.mayCountdown').countdown({until: new Date(2017,4,26,19,30,00)});
    ...
    if ($('#slider1').length) {
        ...
        image_array = [{
                image: '/team/maureen.jpg',
                link_url: 'team/maureen.jpg',
    ...
    if ($('.slide-out-div').length) {
        $('.slide-out-div').tabSlideOut({
            ...
            pathToTabImage: '/assets/images/gear.png', //path to the image for the tab (optionaly can be set using css)
